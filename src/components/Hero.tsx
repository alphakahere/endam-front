...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-primary/10 to-black/5 ">
     <div className="py-20 flex items-center justify-between container mx-auto">
     <div className="lg:w-1/2">
      ...
      <div className="lg:w-1/2 flex justify-end">
        <Image src="/images/hero.png" alt="Hero Image" width={551} height={368} className="rounded-3xl"/>
      </div>
     </div>
    </section>
  );
